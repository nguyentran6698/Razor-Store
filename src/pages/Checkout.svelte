<script>
  ...
  onMount(() => {
    ...
    if ($cartTotal > 0) {
      stripe = Stripe(
        "pk_test_51IVSO8AD2EpISrJYKXCsWpGQDwIzuu59lW63fQGOZItFyv9hWkE3JMmgsqBE1a9xKigS8AXNa8xs7Yz6tYNAxSWr00710YqHl8"
      );
  ...
  <section class="form">
    ...
    >
      ...
      <div class="stripe-input">
        ...
        <div id="card-errors" bind:this={cardError} role="alert" />
      </div>
      <!-- end of stripe stuff -->
      <!-- error message -->
      {#if isEmpty}
